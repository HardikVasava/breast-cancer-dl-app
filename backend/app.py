...
model = load_model('../model_training/models/breast_cancer_diagnostics_model.keras')
scaler = joblib.load('../model_training/models/breast_cancer_diagnostics_scaler.pkl')
